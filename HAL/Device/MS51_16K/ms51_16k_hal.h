 ...
 *******************************************************************************
 * @file    ms51_16k_hal.h
 * @brief   MS51 16K Device HAL Header File
 * @version 1.0.0
 * @date    2024
 *
 ...
 *
 * @details Device-specific definitions for MS51 16K Flash variants:
 *          - MS51FB9AE
 *          - MS51XB9AE
 *          - MS51XB9BE
 *
...
#ifndef __MS51_16K_HAL_H
#define __MS51_16K_HAL_H
 ...
 ******************************************************************************/
#define HAL_FLASH_SIZE          0x4000U     /**< 16K Flash */
#define HAL_SRAM_SIZE           0x0400U     /**< 1K SRAM */
#define HAL_LDROM_SIZE          0x0800U     /**< 2K LDROM */
#define HAL_PAGE_SIZE           128U        /**< Flash page size */

/*******************************************************************************
 * Interrupt Vector Definitions
 ******************************************************************************/
#define HAL_INT_EXT0            0   /**< External Interrupt 0 */
#define HAL_INT_TIMER0          1   /**< Timer 0 Interrupt */
#define HAL_INT_EXT1            2   /**< External Interrupt 1 */
#define HAL_INT_TIMER1          3   /**< Timer 1 Interrupt */
#define HAL_INT_UART0           4   /**< UART0 Interrupt */
#define HAL_INT_TIMER2          5   /**< Timer 2 Interrupt */
#define HAL_INT_I2C             6   /**< I2C Interrupt */
#define HAL_INT_PIN             7   /**< Pin Interrupt */
#define HAL_INT_BOD             8   /**< Brown-Out Detect Interrupt */
#define HAL_INT_SPI             9   /**< SPI Interrupt */
#define HAL_INT_WDT             10  /**< Watchdog Timer Interrupt */
#define HAL_INT_ADC             11  /**< ADC Interrupt */
#define HAL_INT_CAPTURE         12  /**< Input Capture Interrupt */
#define HAL_INT_PWM             13  /**< PWM Interrupt */
#define HAL_INT_PWMFB           14  /**< PWM Fault Brake Interrupt */
#define HAL_INT_UART1           15  /**< UART1 Interrupt */
#define HAL_INT_TIMER3          16  /**< Timer 3 Interrupt */
#define HAL_INT_WKT             17  /**< Wakeup Timer Interrupt */

/*******************************************************************************
 * SFR Register Definitions - Compatible with all compilers
 ******************************************************************************/

/* Include original SFR definitions based on compiler */
#if defined(HAL_COMPILER_KEIL)
    /* Keil SFR definitions */
    sfr P0          = 0x80;
    sfr SP          = 0x81;
    sfr DPL         = 0x82;
    sfr DPH         = 0x83;
    ...
    /* IAR SFR definitions - using __sfr keyword */
    ...
    /* IAR uses bit fields for bit access - defined via macros */
    #define EA          (IE & 0x80)
    #define TF1         (TCON & 0x80)
    #define TR1         (TCON & 0x40)
    #define TF0         (TCON & 0x20)
    #define TR0         (TCON & 0x10)
    #define TI          (SCON & 0x02)
    #define RI          (SCON & 0x01)
    #define REN         (SCON & 0x10)
    #define ADCF        (ADCCON0 & 0x80)
    #define ADCS        (ADCCON0 & 0x40)
#endif

/*******************************************************************************
 * SFR Page 1 Register Definitions
 ******************************************************************************/
/* Page 1 SFRs share addresses with Page 0 but are accessed via SFRS */
#define P0S_ADDR        0xB1    /* Page 1 - Schmitt trigger for P0 */
#define P0SR_ADDR       0xB2    /* Page 1 - Slew rate for P0 */
#define P1S_ADDR        0xB3    /* Page 1 - Schmitt trigger for P1 */
#define P1SR_ADDR       0xB4    /* Page 1 - Slew rate for P1 */
#define P3S_ADDR        0xAC    /* Page 1 - Schmitt trigger for P3 */
#define P3SR_ADDR       0xAD    /* Page 1 - Slew rate for P3 */
#define PWMINTC_ADDR    0xB7    /* Page 1 - PWM Interrupt control */
#define PWM4H_ADDR      0xC4    /* Page 1 - PWM4 high byte */
#define PWM5H_ADDR      0xC5    /* Page 1 - PWM5 high byte */
#define PIOCON1_ADDR    0xC6    /* Page 1 - PWM I/O control 1 */
#define PWM4L_ADDR      0xCC    /* Page 1 - PWM4 low byte */
#define PWM5L_ADDR      0xCD    /* Page 1 - PWM5 low byte */
#define SPCR2_ADDR      0xF3    /* Page 1 - SPI control 2 */

/*******************************************************************************
 * Clock Configuration Constants
 ******************************************************************************/
#define HAL_HIRC_24MHZ      24000000UL
#define HAL_HIRC_16MHZ      16000000UL
#define HAL_LIRC_FREQ       10000UL     /* ~10kHz */

#ifdef __cplusplus
}
#endif

#endif /* __MS51_16K_HAL_H */
